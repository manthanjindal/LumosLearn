      ...
      <div className="max-w-4xl mx-auto">
        {Object.entries(lessonsByTopic).map(([topic, lessons]) => {
          ...
          return (
            <div
              key={topic}
              className="bg-base-950/30 dark:bg-base-950/30 backdrop-blur-md rounded-2xl mb-8 border border-white/10"
            >
              <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 pt-0">
                  {lessons.map((lesson, idx) => {
                    ...
                    return (
                      <div
                        key={lesson}
                        className="bg-gray-900/50 rounded-xl p-6 border border-gray-700 transition-all duration-300 hover:border-purple-400 hover:scale-105 cursor-pointer"
                        onClick={handleClick}
                      >
