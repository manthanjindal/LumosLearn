      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            {t('auth.noAccount')}{' '}
            <Link to="/register" className="text-[#219176] dark:text-[#7fd49c] hover:text-[#7fd49c] dark:hover:text-[#219176] font-medium">
              {t('auth.signUp')}
            </Link>
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#219176] focus:ring-[#219176] border-gray-300 rounded"
              />
            ...
            <a href="#" className="text-sm text-[#219176] dark:text-[#7fd49c] hover:text-[#7fd49c] dark:hover:text-[#219176]">
              Forgot password?
            </a>
          </div>
